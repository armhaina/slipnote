...
trait TestFailedBadRequestTrait
{
    use AbstractTrait;
     ...
     * @throws \Exception
     */
    #[DataProvider('failedBadRequestProvider')]
    public function failedBadRequest(FunctionalTester $I, Scenario $scenario, Example $example): void
    {
        self::setWantTo(scenario: $scenario, wantTo: self::getMethod().'/400 ОШИБКА: '.$example['want_to']);
    ...
    abstract protected function failedBadRequestProvider(): array;
}
